function createUnityInstance(e, r, t) {
    ...
    function d(e) {
        return new Promise(function (r, t) {
            i(e);
            var o = c.companyName && c.productName ? new c.XMLHttpRequest({ companyName: c.companyName, productName: c.productName, cacheControl: c.cacheControl(c[e]) }) : new XMLHttpRequest();
            o.open("GET", c[e]),
                ...
                o.addEventListener("error", function (r) {
                    ...
                    "file:" == location.protocol
                        ? n(t + ". Loading web pages via a file:// URL without a web server is not supported by this browser. Please use a local development web server to host Unity content, or use the Unity Build and Run option.", "error")
                        : console.error(t);
                }),
                o.send();
        });
    ...
    return (
        ...
        (c.XMLHttpRequest = (function () {
            ...
            function o(e, r, t, n, o) {
                var a = { url: e, version: i.version, company: r, product: t, updated: n, revalidated: n, accessed: n, responseHeaders: {}, xhr: {} };
                return (
                    o &&
                    ...
                    this.xhr.addEventListener(
                        ...
                        function () {
                            ...
                            t.enabled &&
                                !t.revalidated &&
                                (304 == r.status
                                    ? ((t.result.revalidated = t.result.accessed), (t.revalidated = !0), l.execute(i.name, "put", [t.result]), e("'" + t.result.url + "' successfully revalidated and served from the indexedDB cache"))
                                    : 200 == r.status
